...
<header>
	...
	<div align="center">
		...
		<h2>
        	...
        	&nbsp;&nbsp;&nbsp;
        	<a href="listActorUser">Actor list</a>
        	&nbsp;&nbsp;&nbsp;
    ...
    <table id="filter-table">
            ...
            <c:forEach var="product" items="${listProduct}">
                <tr class='table-data'>
                    ...
                    <td>
                    	<a href="showActorsUser?id=<c:out value='${product.id}' />">Show actors</a>  
                    		&nbsp;&nbsp;&nbsp;&nbsp;  	
                    	<a href="showCrew-film-user?id=<c:out value='${product.id}' />">ShowCrew</a> 
