    ...
    <table id="filter-table">
            ...
            <c:forEach var="Crew_film" items="${crew_film}">
                <tr class='table-data'>
                    ...
                    <td>
                    	<a href="editCrew?id=<c:out value='${Crew_film.getFilmId()}' />">Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteCrew?id=<c:out value='${Crew_film.getFilmId()}' />" onclick="return confirm('Are you sure you want to delete this crew from film?');">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
