    ...
    <table id="filter-table">
            ...
            <c:forEach var="Actor_Film" items="${actor_film}">
                <tr class='table-data'>
                    ...
                    <td>
                    	<a href="editActor?id=<c:out value='${Actor_Film.getActorId()}' />">Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteActor?id=<c:out value='${Actor_Film.getActorId()}' />" onclick="return confirm('Are you sure you want to delete this actor?');">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
